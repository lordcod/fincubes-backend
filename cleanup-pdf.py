...
# Путь к PDF6
pdf_path = Path(
    r"C:\Users\2008d\Downloads\итоговый протокол.pdf"
)

trash = """
ПЕРВЕНСТВО РЕСПУБЛИКИ МОРДОВИЯ
по подводному спорту (группа спортивных дисциплин: плавание в классических ластах)
Саранск, 31.10-1.11.2025 г. ДВВС, 50 м 
бассейн оснащен электронной системой фиксации времени "OMEGA"ARES-21"
разряд
