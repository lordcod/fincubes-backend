...
pdf_path = Path("Протокол.pdf")
output_text_path = Path("cleaned_results.txt")
log_path = Path("log_removed_lines.txt")

trash_keywords = [
    "ИТОГОВЫЙ ПРОТОКОЛ",
    "Кубок России по подводному спорту",
    "(группа спортивных дисциплин: плавание в ластах, плавание в классических ластах,",
    "подводное плавание, ныряние в ластах в длину)",
    "11-17.02.2025",
    "г. Саратов (Саратовская область)",
    "ДВВС, 50 метров",
    "бассейн оснащен системой электронной фиксации времени SEIKO",
    "Плавательный бассейн",
    "Всероссийские соревнования по подводному спорту",
    "Первенство Томской области",
    "плавание в ластах, плавание в классических ластах, подводное плавание",
    "мужчины, женщины, юниоры, юниорки (14-17 лет), юноши, девушки (12-13 лет)",
    "13-17.12.2024 г",
    "ЦВВС \"Звездный\"",
    "ЦВВС \"Звездный\" - 50 метров",
    ...
    "Место Разряд Фамилия, Имя Г.р. Команда Результат Разряд"
]
