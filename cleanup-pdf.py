...
# Путь к PDF6
pdf_path = Path(
    r"C:\Users\2008d\Downloads\Стайер-2025+Ласты.pdf"
)

trash = """
Управление образования и спорта Тутаевского муниципального района
Первенство города Тутаева по плаванию в классических ластах
Тутаев, 06.12.2025


Telegram бот @BeSwimmerBot
Место Разряд Фамилия
